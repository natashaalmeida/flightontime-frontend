...
import { predictFlightMock } from "../services/mockApi";
//import { predictFlight } from "../../services/api";
// depois troque para: import { predictFlight } from "../services/api"; quando o back tiver total pronto!!
...
function PredictFlight() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await predictFlightMock(form);
    setResult(response);
